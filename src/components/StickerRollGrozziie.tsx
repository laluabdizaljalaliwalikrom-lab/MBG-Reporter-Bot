...
export default function StickerRollGrozziie(props: StickerRollGrozziieProps) {
  ...
  const renderLeftLabel = (keySuffix: string = "left") => (
    ...
    >
      ...
      >
        <span style={{ fontSize: "14px", color: "#000000", fontWeight: 900 }}>◀</span>
        <span
          style={{
      ...
      >
        ...
        >
          <span style={{ fontSize: "15px" }} role="img" aria-label="broccoli">🥦</span>
          <span style={{ fontSize: "15px" }} role="img" aria-label="apple">🍎</span>
          <span style={{ fontSize: "15px" }} role="img" aria-label="carrot">🥕</span>
          <span style={{ fontSize: "15px" }} role="img" aria-label="banana">🍌</span>
          <span style={{ fontSize: "15px" }} role="img" aria-label="corn">🌽</span>
          <span style={{ fontSize: "15px" }} role="img" aria-label="orange">🍊</span>
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#000000", fontWeight: 900, letterSpacing: "0.8px" }}>
            SEGEL KANAN
          </span>
        </div>
      </div>
